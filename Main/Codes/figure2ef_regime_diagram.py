...
#parameters
##simulation
simulation_name = f'Hyperbolic-thermo-DYE2-CH_phase_diagram_low_res_fancy_T_with_DIFFUSION'
diffusion = 'yes'
CFL    = 0.1     #CFL number
...
##thermodynamics
T_firn = -4  # temperature of firn [C]
...
phi_nw_init = 0.5#0.5    # volumetric ratio of gas, decreasing exponentially
...
Grid.ymin =  0*z0; Grid.ymax =10;  Grid.Ny = 400;
